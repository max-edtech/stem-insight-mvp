...
export default function ForestQuizPage() {
  const quizData = questions.filter((q) => q.biome === "forest");
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 flex flex-col items-center">
      ...
      <h1 className="text-3xl font-bold mb-8 text-emerald-800">Forest Biome Quiz</h1>
